...
class SinglePostView(View):
    ...
    def post(self, request, slug):
        ...
        if comment_form.is_valid():
            # instead of saving directly into the database, it will create an instance of that model of the ModelForm instead
            # Then we can add what ever we want, here is a post, because we exclude it in the ModelForm
